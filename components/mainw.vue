      ...
      <div class="main-text-wrap">
       <div class="main-text">
          ...
          <div class="main-subtitle">
            <p>
            <span>
            На консультации Я Вам раскрою настоящую причину, которая забрала у вас годы радости и наслаждений. Это причина инфовируса заложенная с детсва, убеждения программы которая уничтожает человеческую жизнь и его потомков. Насколько ВЫ готовы его убрать? 
            </span>
            <span>
                ...
                <span>
                Запишитесь, на сеанс, если вы не получите нужные излечения последствием трансформаций, могут возникнуть сложные болезни и страхи жизни как разные фобий, боязнь будущего, депрессия, онкология и гормональные растроиства которые возможно, уже находятся внутри Вас.</span>   
                </p>
          </div>
       </div>
       <div class="main-buttons">
           <div class="zapisatsa" @click="dialog = true">
               <p>ЗАПИСАТЬСЯ</p>
           </div>
           <div class="konsultatsia" @click="dialog = true">
               <p>КОНСУЛЬТАЦИЯ</p>
           </div>
       </div>
    </div>
