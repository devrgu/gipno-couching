               ...
               <div class="tfs-content">
                   <div class="tfs-block-1 tfs-block tfs-block-therapy">
                       ...
                       <div class="tfs-block-text">
                           <p>В процессе лечения, найдем эмоциональные травмы или же инфовирус, который оброс корнем как паразит высасывая жизненную энергию. А точнее "убеждения", привели бы вас к самоуничтожению. Мы вместе с вами остановим и вырвем с корнем, меняя ваши "Убеждения".</p>
                       </div>
                   </div>
